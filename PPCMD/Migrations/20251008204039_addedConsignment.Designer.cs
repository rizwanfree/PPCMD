...
namespace PPCMD.Migrations
{
    ...
    [Migration("20251008204039_addedConsignment")]
    partial class addedConsignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PPCMD.Models.BLItem", b =>
                {
                    ...
                    b.Property<decimal?>("InsurancePKR")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("InsuranceUSD")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("InvoiceValue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("InvoiceValuePKR")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("ItemId")
                        .HasColumnType("int");

                    b.Property<decimal?>("LandingCharges")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PPCMD.Models.Consignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ConsignmentTitle")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PPCMD.Models.Consignment", b =>
                {
                    ...
                    b.HasOne("PPCMD.Models.LC", "LC")
                        .WithOne()
                        .HasForeignKey("PPCMD.Models.Consignment", "LCId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
